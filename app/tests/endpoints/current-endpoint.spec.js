        ...
        mockery.registerMock('axios', (configuration) => {
            ...
            switch(configuration.url) {
                ...
                case 'http://ipapitest':
                    ...
                    break;
                case 'http://weathermapurl/data/2.5/weather?lat=1&lon=-1&appid=123':
                    response.data = true;
            }
    ...
    it(('with city - status 200'), () => {
        request(this.app)
            ...
            .end((err, res) => {
                ...
                res.body[0].weather.should.equal(true);
            });
    });

    it(('with city - status 400'), () => {
        request(this.app)
            .get('/v1/current/testcityerror')
            .expect(400)
